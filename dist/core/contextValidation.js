...
const contextValidation = (session, context) => {
    context = {
            ...
            switch (key) {
                case "bap_id":
                    if ((action !== "search" || action !== "on_search") &&
                        ...
                        errors.push(`bap_id should be equal to ${SERVER_TYPE === "BAP" ? SUBSCRIBER_ID : session.bap_id}`);
                    }
                    return;
                case "bap_uri":
                    if ((action !== "search" || action !== "on_search") &&
                        ...
                        errors.push(`bap_uri should be equal to ${SERVER_TYPE === "BAP" ? SUBSCRIBER_URL : session.bap_uri}`);
                    }
                    return;
                case "bpp_id":
                    if ((action !== "search" || action !== "on_search") &&
                        ...
                        errors.push(`bpp_id should be equal to ${SERVER_TYPE === "BPP" ? SUBSCRIBER_ID : session.bap_id}`);
                    }
                    return;
                case "bpp_uri":
                    if ((action !== "search" || action !== "on_search") &&
                        ...
                        errors.push(`bpp_uri should be equal to ${SERVER_TYPE === "BPP" ? SUBSCRIBER_URL : session.bap_uri}`);
                    }
                    return;
                case "location":
                    if (!((_a = value === null || value === void 0 ? void 0 : value.country) === null || _a === void 0 ? void 0 : _a.code) || value.country.code !== session.country) {
                        errors.push(`location.country.code should be equal to ${session.country}`);
                    }
                    if (!((_b = value === null || value === void 0 ? void 0 : value.city) === null || _b === void 0 ? void 0 : _b.code) || value.city.code !== session.cityCode) {
                        errors.push(`location.city.code should be equal to ${session.country}`);
                    }
                    return;
                case "transaction_id":
                    return;
                case "message_id":
                    if (session.allMessageIds.includes(value)) {
                        errors.push(`${value} already used as a message_id in previous transaction.`);
                    }
                ...
                case "timestamp":
                    if ((session === null || session === void 0 ? void 0 : session.lastTimestamp) &&
                        ...
                        errors.push(`timestamp should be greater then last call. current call: ${value}, last call: ${session.lastTimestamp}`);
                    }
