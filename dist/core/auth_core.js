...
exports.verifyHeader = void 0;
exports.generateHeader = generateHeader;
const ondc_crypto_sdk_nodejs_1 = require("ondc-crypto-sdk-nodejs");
const axios_1 = __importDefault(require("axios"));
const LOOKUP_URI = process.env.ondc_LOOKUP_URI, PRIVATE_KEY = process.env.PRIVATE_KEY, BAPID = process.env.SUBSCRIBER_ID, UNIQUE_KEY = process.env.SUBSCRIBER_UNIQUE_KEY;
function generateHeader(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield (0, ondc_crypto_sdk_nodejs_1.createAuthorizationHeader)({
            message: message,
...
const getPublicKey = (header) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!LOOKUP_URI) {
        ...
        yield axios_1.default
            ...
            publicKey = (_a = response[0]) === null || _a === void 0 ? void 0 : _a.signing_public_key;
        });
        return publicKey;
    }
    catch (error) {
...
const verifyHeader = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const headers = req.headers;
    if (headers === undefined) {
        return false;
    }
    const public_key = yield getPublicKey(headers);
    if (!public_key) {
    ...
    const isValidSource = yield (0, ondc_crypto_sdk_nodejs_1.isSignatureValid)({
        header: headers === null || headers === void 0 ? void 0 : headers.authorization, // The Authorisation header sent by other network participants
        body: req.body,
